...
public class CrabbyContainer implements RobotContainer
{
    ...
    public void periodic()
    {
        ...
        map.logOutputs("Map");
        Logger.recordOutput("OrangePi/Distance", orangePi.getDistanceToSpeaker(CrabbyConstants.OrangePiConstants.cameraHeight,
            CrabbyConstants.OrangePiConstants.cameraPitch).orElse(0.));
        var distance =
