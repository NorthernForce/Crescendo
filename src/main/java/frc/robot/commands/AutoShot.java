...
public class AutoShot extends SequentialCommandGroup {
    public AutoShot(SwerveDrive drive, Shooter shooter, NFRPhotonCamera orangePi, WristJoint wristJoint, Intake intake, Indexer indexer, DoubleSupplier topSpeed, DoubleSupplier bottomSpeed, Supplier<Rotation2d> wristSupplier)
    {
        addCommands(
