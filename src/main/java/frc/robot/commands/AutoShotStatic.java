...
public class AutoShotStatic extends SequentialCommandGroup {
    public AutoShotStatic(SwerveDrive drive, NFRSwerveModuleSetState[] setStateCommands, Intake intake, Indexer indexer, WristJoint wrist,
        ...
        TargetingCalculator wristCalculator)
    {
        addCommands(
            new ParallelCommandGroup(
                new TurnToTargetStatic(drive, setStateCommands, CrabbyConstants.DriveConstants.turnToTargetController,
                    () -> camera.getSpeakerTag(), true),
